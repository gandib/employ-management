      ...
      <div className='flex justify-center items-center overflow-auto p-10'>
        ...
        >
          ...
          <div className='flex flex-col w-full max-w-xs'>
            ...
            <input className="text-lg py-2 px-5 border border-gray-300 focus:ring-primary rounded-3xl cursor-not-allowed" type='email' id='email' disabled {...register("email")} />
          </div>
          <div className='flex flex-col w-full max-w-xs'>
          ...
          <div className='flex flex-col w-full max-w-xs'>
            ...
            <input className="text-lg py-2 px-5 border border-gray-300 focus:ring-primary rounded-3xl" type='text' {...register("companyName")} id='companyName' />
          </div>
          <div className='flex flex-col w-full max-w-xs'>
            <label className='mb-3' for='employeeRange'>
              Number of employee
            </label>
            <select className="text-lg py-2 px-5 border border-gray-300 focus:ring-primary rounded-3xl" {...register("employeeRange")} id='employeeRange'>
              {employeeRange
          ...
          <div className='flex flex-col w-full max-w-xs'>
            ...
            <select className="text-lg py-2 px-5 border border-gray-300 focus:ring-primary rounded-3xl" {...register("companyCategory")} id='companyCategory'>
              {businessCategory
                .sort((a, b) => a.localeCompare(b))
                .map((category) => (
                  <option value={category}>{category}</option>
